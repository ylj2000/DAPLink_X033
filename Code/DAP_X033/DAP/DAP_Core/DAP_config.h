...
__STATIC_FORCEINLINE void     PIN_nRESET_OUT (uint32_t bit) {
  ...
  if(bit&0x01)
  {
    write_data = 0x05fa0004;SWD_Transfer(0x0d,&write_data);
    GPIOA->BSHR=1<<4;
  }
  else
  {
    write_data = 0xe000ed0c;SWD_Transfer(0x05,&write_data);
    GPIOA->BCR=1<<4;
  }
}
